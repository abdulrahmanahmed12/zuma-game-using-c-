...
namespace Graphics1_Project
{
    ...
    public partial class Form1 : Form
    {
        ...
        void createCurve()
        {
            ...
            mycurve.LCtrPts.Add(new PointF(109, 151));
            mycurve.LCtrPts.Add(new PointF(525, 49));
            mycurve.LCtrPts.Add(new PointF(961, 7));
            mycurve.LCtrPts.Add(new PointF(930, 64));
            mycurve.LCtrPts.Add(new PointF(1110, 36));
            mycurve.LCtrPts.Add(new PointF(1534, 81));
            ...
            mycurve.LCtrPts.Add(new PointF(1735, 349));
            mycurve.LCtrPts.Add(new PointF(1535, 478));
            mycurve.LCtrPts.Add(new PointF(1535, 479));
            // mycurve.LCtrPts.Add(new PointF(1458, 523));
            mycurve.LCtrPts.Add(new PointF(1333, 341));
            mycurve.LCtrPts.Add(new PointF(1443, 430));
            mycurve.LCtrPts.Add(new PointF(1800, 1302));
            mycurve.LCtrPts.Add(new PointF(1100, 2000));
            mycurve.LCtrPts.Add(new PointF(100, -2300));
            mycurve.LCtrPts.Add(new PointF(1506, 550));
            mycurve.LCtrPts.Add(new PointF(1030, -903));
            mycurve.LCtrPts.Add(new PointF(906, 921));
            mycurve.LCtrPts.Add(new PointF(803, 561));
            mycurve.LCtrPts.Add(new PointF(103, -300));
            mycurve.LCtrPts.Add(new PointF(-2530, -50));
            mycurve.LCtrPts.Add(new PointF(350, 765));
            mycurve.LCtrPts.Add(new PointF(80, 1400));
            mycurve.LCtrPts.Add(new PointF(300, 590));
            mycurve.LCtrPts.Add(new PointF(400, 1030));
            mycurve.LCtrPts.Add(new PointF(680, 630));
            mycurve.LCtrPts.Add(new PointF(880, 700));
            mycurve.LCtrPts.Add(new PointF(1100, 750));
            mycurve.LCtrPts.Add(new PointF(1380, 910));
            mycurve.LCtrPts.Add(new PointF(2230, 400));
            mycurve.LCtrPts.Add(new PointF(1200, 380));
            mycurve.LCtrPts.Add(new PointF(1100, 430));
            mycurve.LCtrPts.Add(new PointF(900, 700));
            mycurve.LCtrPts.Add(new PointF(700, 650));
            // mycurve.LCtrPts.Add(new PointF(90, 560));
            // mycurve.LCtrPts.Add(new PointF(60, 560));


            //
            ////old points (unmodefied)
            //mycurve.LCtrPts.Add(new PointF(0, 223));
